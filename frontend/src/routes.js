...
const AnalisisLaporan = React.lazy(() => import('./views/analisisdanlaporan/AnalisisLaporan'))

//profil
const Profil = React.lazy(() => import('./views/profil/Profil'))

//produk
const Produk = React.lazy(() => import('./views/produk/Produk'))
...
export const routes = [
  ...
  // Di dalam file routes.js atau file router utama kamu:
{ path: '/analisis-laporan', name: 'Analisis & Laporan', element: AnalisisLaporan },
